...
execute as @e[type=marker,tag=lodestone_teleport.TeleportHelper,sort=nearest,limit=1] run function lodestone_teleport:teleport_execute_with with entity @e[type=marker,tag=lodestone_teleport.TeleportHelper,sort=nearest,limit=1] data.lodestone_teleport:target
